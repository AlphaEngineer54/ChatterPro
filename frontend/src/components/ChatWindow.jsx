    ...
    return (
      <div className="flex flex-1 flex-col items-center justify-center bg-slate-50 text-center">
        <div className="max-w-sm px-6">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-accent-50 text-2xl">
            💬
          </div>
          <h2 className="text-lg font-semibold text-slate-800">Bienvenue sur ChatterPro</h2>
    ...
    <div className="flex flex-1 flex-col bg-slate-50">
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Conversation #{conversation.id}</p>
        </div>
      ...
      <div className="flex-1 space-y-3 overflow-y-auto px-6 py-4">
        {loading ? (
          <p className="py-8 text-center text-sm text-slate-400">Chargement des messages…</p>
        ) : messages.length === 0 ? (
