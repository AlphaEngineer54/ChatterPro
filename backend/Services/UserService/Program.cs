...
builder.Services.AddSwaggerGen(options =>
{
    ...
    // Optionnel : activer les commentaires XML si g�n�r�s
...
// Injecter les d�pendances au conteneur
...
// SAGA (orchestrateur) : canal RPC + consommateur de réponses, actif en continu.
